...
MSG_MIRROR_CONFIRM_CHANGE="About to switch system software mirrors. Continue? [Y/n]"
MSG_MIRROR_CONFIRM_RESTORE="About to restore official software sources. Continue? [Y/n]"
