...
MSG_WIZARD_STEP_SSH="[1/8] SSH Security Hardening"
MSG_WIZARD_STEP_FIREWALL="[2/8] Firewall Configuration"
MSG_WIZARD_STEP_FAIL2BAN="[3/8] Fail2Ban Intrusion Prevention"
MSG_WIZARD_STEP_AUDIT="[4/8] Audit Logging Configuration"
MSG_WIZARD_STEP_USERS="[5/8] User Management"
MSG_WIZARD_STEP_KERNEL="[6/8] Kernel Security Hardening"
MSG_WIZARD_STEP_FILESYSTEM="[7/8] Filesystem Security"
MSG_WIZARD_STEP_SUMMARY="[8/8] Change Summary & Confirmation"
