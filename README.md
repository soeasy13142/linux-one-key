...
[![Bats Tests](https://img.shields.io/badge/Tests-827-brightgreen.svg)](tests/unit/)
...
- **827 个** Bats 测试用例覆盖全部模块（827 test cases across all modules）
...
| 版本 | 日期 | 说明 |
|------|------|------|
| v1.9.0 | 2026-08-18 | `--version` 版本/变更查询、zh/en 键集对称测试、README 安全警示、写入安全护栏（符号链接/边界）、11 个 server 模块状态感知子菜单；827 Bats |
